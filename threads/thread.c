...
{
	// 인터럽트가 비활성화된 상태인지 확인
	// 인터럽트 활성화 상태라면 thread_init() 함수 중지
...
do_schedule(int status)
{
	...
	// 스레드의 종료 요청이 저장되는 리스트가 비어있지 않다면
...
// ready_status -> running_status로 전환
static void
schedule(void)
{
